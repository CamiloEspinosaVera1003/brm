    ...
    <div class="fixproduct">
        <form method="POST" action="main/fix.php">
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" value="<?php echo $_GET['lote'] ?>" class="form-control" name="lote" required>
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" value="<?php echo $_GET['cantidad_disponible'] ?>" class="form-control" name="cantidad_disponible" required>
                <input type="hidden" value="<?php echo $_GET['id'] ?>" name="id" />
            </div> 
            <div class="form-group">
                <label for="exampleInputPassword1">Valor producto</label>
                <br>
